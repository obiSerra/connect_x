...
from connectx.environment import ConnectFourGymV2, ConnectFourGymV3, ConnectFourGymV4, ConnectFourGymV5, ConnectFourGymV6, ConnectFourGymV13
...
elif sys.argv[1].endswith("v13"):
    print("Using V13")
    env = ConnectFourGymV13(agent2="random")
else:
    print("Using V2")
